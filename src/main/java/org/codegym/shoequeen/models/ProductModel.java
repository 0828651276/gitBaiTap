...
import org.codegym.shoequeen.enties.Product;
...
public class ProductModel {
    ...
    public void addProduct(Product product) throws SQLException {
        // viet sql
        String sql = "INSERT INTO products (product_name, description, price, image_url ) VALUES (?,?,?,?)";
        // dua cau lenh truy van
        PreparedStatement statement = connection.prepareStatement(sql);
        // thay the du lieu vao cau lenh
    ...
    public void updateProduct(Product product) throws SQLException {
        // viet sql
        String sql = "UPDATE products SET product_name=?, description=?, price=?, image_url=? WHERE product_id=?";
        // dua cau lenh truy van
        PreparedStatement statement = connection.prepareStatement(sql);
        // thay the du lieu vao cau lenh
        statement.setString(1, product.getName());
